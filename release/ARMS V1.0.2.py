    ...
    **Made by Linhan Song😘**
    ...
    if submit_button:
            ...
            for track_id in boxes:
                ...
                max_overlap = max(
                    (
                        ...
                        if other_id != track_id and len(effective_track[other_id]) >= 5
                    ),
                    default=0
                )
        ...
        for _ in frame_generator:
            ...
            cv2.putText(annotated_frame, f"ARMS V1.0.1", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (71, 210, 160), 2,
                        cv2.LINE_AA)
